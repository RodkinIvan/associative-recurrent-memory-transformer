...
# DEEPSPEED_CONFIG=$(pwd)/accel_configs/exp/deepspeed/0s2_bf16_tbs${TBS}bs${BS}g${GRAD_ACC_STEPS}c1.0.json # DEEPSPEED
...
export WANDB_NAME=armt_${LAST_MODEL_NAME}_${LAST_DATASET_NAME}
